                            ...
                            <div class="modal-body">  
                                <div class="col-md-12">
                                    ...
                                    foreach ($tpAtividade as $dados) {
                                        ...
                                        if($id_tipo_atividade == 1 || $id_tipo_atividade == 2){
                                        ?>

                                        <button class="btn btn-success col-md-5 col-md-offset-1" onclick="getCertificadoAtividade('<?php echo $id_evento; ?>', '<?php echo $id_tipo_atividade; ?>');"><i class="fa fa-graduation-cap "></i> <?php echo $nome_atividade; ?></button>
