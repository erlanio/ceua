    ...
    <body>
        <div class="corpo">
            <div class="texto">
                ...
                <strong> <?php echo mb_strtoupper($titulo, "utf-8") ?> </strong>, com o tema: <strong> <?php echo mb_strtoupper($descricao, "utf-8") ?>;</strong> perfazendo uma carga horária de <?php echo $horas; ?> horas. Realizado na <?php echo $local?>, no período de <?php echo $periodo; ?>.
            </div>   
