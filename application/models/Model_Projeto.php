...
class Model_Projeto extends CI_Model {
    ...
    public function salvarProcedimentos($data) {
        return $this->db->insert('procedimentos', $data);
    }

    public function buscarProcedimento($id) {
        $this->db->where('id_projeto', $id);
        return $this->db->get('procedimentos')->result();
    }

    public function updateProcedimento($data, $id) {
        $this->db->where('id_procedimento', $id);
        return $this->db->update('procedimentos', $data);
    }
