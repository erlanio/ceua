...
function validarFromSolicitacao() {
    ...
    if ($nome == "" || $local == "" || $descricao == "" || $dtIni == "" || $dtFim == "" || $email == "" || $ch == "" || $periodo == "" || $temSub == "" || $freqAPP == "") {
...
function salvarAtividade() {
    ...
    if (nome == "" || local == "" || ch == "" || dtIni == "" || dtFim == "" || max == "" || freqApp == "" || ins == "" || tipo == "" || id_evento == "") {
        ...
        setTimeout(location.href="http://cev.urca.br/siseventos/admin/relatorios/exibirRelatorio/"+id_evento, 1000);
    }
...
function eventoGratuito() {
    $id_evento = $('#id_evento').val();
    $.ajax({
        url: 'http://cev.urca.br/siseventos/admin/Evento/cadEventoGratuito',
        type: 'POST',
        dataType: 'html',
        data: ({
            'id_evento': $id_evento,
